-- ============================================
-- Fix: Ambiguous column reference in get_dashboard_metrics
-- ============================================
-- The MRR calculation was using 'montant_ht' without table prefix,
-- causing ambiguity between project_recurrents.montant_ht and projects.montant_ht
...
BEGIN
  SELECT json_build_object(
    ...
    -- FIX: Added pr. prefix to montant_ht to avoid ambiguity
    'mrr', COALESCE((
      SELECT SUM(
        CASE pr.frequence
